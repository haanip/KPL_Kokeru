					  ...
					  <th>Action</th>
 						...
 						<?php
							...
							while ($row = $result->fetch_object()){
								...
								echo '<td><span class="tag tag-primary"><a href="#">Lihat Detail</span></td>';
								echo '<td><a class="btn btn-warning btn-sm" href="peng_edit_ruang.php?id='.$row->id_ruang.'">Edit</a>&nbsp;&nbsp;'?>
									<a class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin untuk menghapus kategori ini?')" <?php echo 'href="peng_delete_ruang.php?id='.$row->id_ruang.'">Delete</a>
									</td>';
								echo '</tr>';
							...
							echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-info" href="peng_create_ruang.php">Create</a>';
