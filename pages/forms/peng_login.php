...
if(isset($_POST["submit"])){
    ...
    if($valid){
        //Assign a query
        $query =  "SELECT * FROM pengelola WHERE email = '".$email."' AND password='".md5($password)."' ";
        //Execute the query
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Halaman Login Pengelola</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<!-- Horizontal Form -->
            <div class="card card-info shadow p-3 mb-5 bg-white rounded" style="width: 40%; margin: 20px auto; border-radius: 25px; box-sizing: border-box; padding: 15px 20px;">
              <div class="card-header">
                <h3 class="card-title">Form Login Pengelola</h3>
              </div>    
              <!-- /.card-header -->
              <!-- form start -->
